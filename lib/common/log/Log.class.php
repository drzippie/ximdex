...
require_once 'Appender.class.php' ;
...
class Log {
	...
	function & factoryLayout($type, $template) {
		...
		$class = "Layout_$type";
		$class_path =  "layout/$class.class.php";
	...
	function & factoryAppender( $params ) {
		...
		$class_path =  "appender/$class.class.php";
	...
	function & factoryGetter($type, &$layout, $params) {
		...
		$class = "Getter_$type";
		$class_path = "getter/$class.class.php";
	...
	function & factoryLogger($name, $type, $params) {
		...
		$class = "Logger_$type";
		$class_path = "logger/$class.class.php";
