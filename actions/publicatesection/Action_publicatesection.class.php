...
class Action_publicatesection extends ActionAbstract {
    ...
    function index() {
		...
		$values = array(
			...
			"folderName" => in_array($nodeTypeName, array('XimNewsSection', 'Section', 'XimNewsImagesFolder', 'XimNewsImagesRootFolder', 'ImagesFolder', 'ImagesRootFolder', 'CssRootFolder', 'CssFolder', 'CommonFolder', 'CommonRootFolder','XimNewsImagesFolder')) ? 'secci�n' : 'servidor'
		);
	...
	function publicate_section() {
		...
		$nodeTypeName = $node->nodeType->GetName();
		$folderName = in_array($nodeTypeName, array('XimNewsSection','Section','XimNewsImagesRootFolder','XimNewsImagesFolder','ImagesFolder', 'ImagesRootFolder', 'CssFolder', 'CssRootFolder','CommonFolder','CommonRootFolder','XimNewsImagesFolder')) ? 'La secci�n' : 'El servidor';
