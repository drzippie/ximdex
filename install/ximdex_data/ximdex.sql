...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6004,5009,'Manage groups','modifyusergroups','manage_user_groups.png','Enroll, disenroll, and change user role in groups where he/she belongs to',90,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6007,5015,'Configure section','managefolders','change_name_section.png','Configure the folders of a section',11,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6015,5016,'Add new image folder','addfoldernode','add_folder_images.png','Create a new image folder',15,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6016,5017,'Add new image folder','addfoldernode','add_folder_images.png','Create a new image folder',15,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6018,5020,'Add ximclude folder','addfoldernode','add_import.png','Create a new import folder',25,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6019,5021,'Add ximclude folder','addfoldernode','add_import.png','Create a nex import folder',35,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6020,5022,'Add common folder','addfoldernode','add_folder_common.png','Create a new common folder',25,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6021,5023,'Add common folder','addfoldernode','add_folder_common.png','Create a new common folder',25,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6023,5025,'Add CSS folder','addfoldernode','add_folder_css.png','Create a new CSS folder',23,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6025,5015,'Change section name','renamenode','change_name_section.png','Change a section name',15,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6027,5014,'Change server name','renamenode','change_name_server.png','Change a server name',40,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6028,5017,'Change name','renamenode','change_name_folder_images.png','Change name of selected folder',22,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6031,5023,'Change name','renamenode','change_name_folder_common.png','Change name of selected folder',26,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6036,5015,'Delete section','deletenode','delete_section.png','Delete a section',82,NULL,1,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6043,5018,'Add XML documents','fileupload_common_multiple','add_xml.png','Create new XML documents in several languages',10,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6044,5018,'Add new document','createxmlcontainer','add_xml.png','Create a new document structured in several languages',9,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6064,5031,'Change name of XML document','renamenode','change_name_xml.png','Change the document name and all its language versions',15,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6063,5031,'Delete document','deletenode','delete_xml.png','Delete XML document in all its languages',20,NULL,1,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6125,5014,'Manage servers','modifyserver','modify_sinc_data.png','Modify data connection with the production environment',9,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6129,5041,'Move to previous state','workflow_backward','change_last_state.png','Move a text document to the previous state',-10,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6130,5040,'Publish','workflow_forward','change_next_state.png','Move a text document to the next state',72,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6131,5040,'Move to previous state','workflow_backward','change_last_state.png','Move a text document to the previous state',-10,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6132,5028,'Publish','workflow_forward','change_next_state.png','Move a text document to the next state',72,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6133,5028,'Move to previous state','workflow_backward','change_last_state.png','Move a text document to the previous state',-10,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6135,5032,'Symbolic link','xmlsetlink','file_xml_symbolic.png','Modify document which borrows the content',79,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6136,5032,'Edit in text mode','edittext','edit_file_xml_txt.png','Edit content of structured document in plain text',3,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6137,5054,'Add new ximlet folder','addfoldernode','add_folder_ximlet.png','Create a new ximlet folder',20,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6139,5055,'Add new ximlet folder','addfoldernode','add_folder_ximlet.png','Create a new ximlet folder',20,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6345,5026,'Add templates','fileupload_common_multiple','add_template_ptd.png','Add a set of templates to the server',10,NULL,0,'type=ptd');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6621,5053,'Copy','copyNode','copiar_seccion.png','Copy a complete schema',-93,'ximIO',0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (6622,5026,'Copy','copyNode','copiar_carpeta_ximptd.png','Copy a complete template',-93,'ximIO',0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (7203, 5014, 'Copy', 'copy', 'copiar_servidor.png', 'Copy a server to another destination', '85', NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (7213, 5031, 'Copy', 'copy', 'copiar_carpeta_ximdoc.png', 'Copy a document to another destination', '85', NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES('7225', '5015', 'Copy', 'copy', 'copiar_seccion.png', 'Copy a section to another destination', '85', NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`, `Sort`, `Module`, `Multiple`, `Params`) VALUES (7307, 5013, 'Modify properties', 'manageproperties', 'xix.png', 'Modify properties of a project', 94, NULL, 0, NULL);
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`, `Sort`, `Module`, `Multiple`, `Params`) VALUES (7310, 5018, 'Modify properties', 'manageproperties', 'xix.png', 'Modify properties of a document folder', 80, NULL, 0, NULL);
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (8104, 5025, 'Publish section', 'publicatesection', 'publicate_section.png', 'Publish a section massively', 75, NULL, 1, '');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (8105, 5022, 'Publish section', 'publicatesection', 'publicate_section.png', 'Publish a section massively', 27, NULL, 1, '');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)  VALUES (8106, 5023, 'Publish section', 'publicatesection', 'publicate_section.png', 'Publish a section massively', 27, NULL, 1, '');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`,`IsBulk`)  VALUES (8122,5022,'Add empty file','newemptynode','add_file_common.png','Create a new empty file',15,NULL,0,'',0);
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`,`IsBulk`)  VALUES (8123,5023,'Add empty file','newemptynode','add_file_common.png','Create a new empty file',15,NULL,0,'',0);
